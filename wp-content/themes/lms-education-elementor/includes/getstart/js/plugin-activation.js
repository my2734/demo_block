jQuery(document).ready(function($) {
    'use strict';
    var this_obj = lms_education_elementor_plugin_activate_plugin;

    $('#wpelemento_importer_editor .plugin-activation-redirect a').addClass('wpi-redirect-to-dashboard');

    $(document).on('click', '.lms-education-elementor-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message lms-education-elementor-plugin-install');
                button.addClass('button-primary lms-education-elementor-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.lms-education-elementor-recommended-plugins .lms-education-elementor-activation-note').css('display','block');
    ...
    $(document).on('click', '.lms-education-elementor-plugin-activate', function(event) {
