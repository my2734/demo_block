...
if (!function_exists('medical_healthcare_elementor_after_setup_theme')) {
	...
	function medical_healthcare_elementor_after_setup_theme() {
		...
		if (is_admin() && ('themes.php' == $pagenow) && isset($_GET['activated']) && wp_get_theme()->get('TextDomain') === 'medical-healthcare-elementor') {
			wp_redirect(admin_url('themes.php?page=medical_healthcare_elementor_about'));
		}
	}
...
if (!function_exists('medical_healthcare_elementor_widgets_init')) {
	...
	function medical_healthcare_elementor_widgets_init() {
		...
		register_sidebar(array(
			...
			'name' => esc_html__('Footer sidebar','medical-healthcare-elementor'),
			'id'   => 'medical-healthcare-elementor-footer-sidebar',
			'description'   => esc_html__('This sidebar will be shown next at the bottom of your content.', 'medical-healthcare-elementor'),
...
function medical_healthcare_elementor_max_title_length( $title ) {
	$max = 20;
	if( strlen( $title ) > $max ) {
...
add_filter( 'the_title', 'medical_healthcare_elementor_max_title_length');
...
define('MEDICAL_HEALTHCARE_ELEMENTOR_PRO_DOC',__('https://www.wpelemento.com/theme-documentation/medical-healthcare-elementor-pro/','medical-healthcare-elementor'));
